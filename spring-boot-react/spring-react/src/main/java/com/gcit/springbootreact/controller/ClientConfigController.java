...
public class ClientConfigController {
    ...
    public ResponseEntity createClientConfig(@RequestBody ClientConfig clientConfig) throws URISyntaxException {
        ...
        System.out.println("1" +savedClientConfig);
//        Client client = clientRepository.findByName(savedClientConfig.getClient().getName());
        Client client = clientRepository.findByName(clientConfig.getClient().getName());
        System.out.println("2" + savedClientConfig);
        savedClientConfig.setClient(client);
        System.out.println("3" +savedClientConfig);
